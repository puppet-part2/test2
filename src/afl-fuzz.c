...
u64 have_value[favorite_list_len];
u64 value_num = 0;
...
int select_bytelen(void) {
  ...
  for (i_puppet = 0; i_puppet < 3; i_puppet++)
  {
...
void dict2dhash_dictcount(void)
{
  ...
  for(int i = 0; i < 4096; i++)
  {
    ...
    while(dict2d_cur != NULL)
    {
      ...
      {
        if(dict1d_cur->countnum < dictcount)
        {
          if(dict1d == dict1d_cur)
          {
            dict1d = dict1d->next;
            dict2d_cur->subdata = dict1d;
            dict2d_cur->subdata_count--;
            dict2d_cur->totalcount -= dict1d_cur->countnum;
            ck_free(dict1d_cur);
            dict1d_cur = dict1d;
            continue;
          }     
          else{
            dict1d->next = dict1d_cur->next;
            dict2d_cur->subdata_count--;
            dict2d_cur->totalcount -= dict1d_cur->countnum;
            ck_free(dict1d_cur);
      ...
      if(dict2d_cur->subdata == NULL)
      {
        if(dict2d_prev == dict2d_cur)
        {
          dict2d_prev = dict2d_prev->next;
          dict2d_hash[i] = dict2d_prev;
          ck_free(dict2d_cur);
          dict2d_cur = dict2d_prev;
          continue;
        }
        else{
          dict2d_prev->next = dict2d_cur->next;
          ck_free(dict2d_cur);
          dict2d_cur = dict2d_prev->next;
          continue;
        }
      }
      else{   //dict2d_cur->subdata != NULL
        dict1d_cur = dict2d_cur->subdata;
        u64 tmptotalcount = 0;
...
void dict_incremental(void)
{
    ...
    while (lognow)
    {
        ...
        if(dict2d_cur)
        {
            ...
            while (dict2d_cur)
            {
                if(dict2d_cur->indata == lognow->indata && dict2d_cur->bytelen == lognow->bytelen)
                    break;
                dict2d_prev = dict2d_cur;
                dict2d_cur = dict2d_cur->next;
            }
            if(dict2d_cur == NULL)
            {
                dict2d_cur = (struct start_byte*) ck_alloc(sizeof(struct start_byte));
                dict2d_cur->indata = lognow->indata;
                dict2d_cur->bytelen =  lognow->bytelen;
                dict2d_cur->change_list = 1;
                dict2d_cur->totalcount = 1;
                dict2d_cur->usenum = 0;
                dict2d_cur->subdata_count = 1;
                dict2d_cur->next = NULL;
                dict2d_cur->subdata = NULL;
                dict1d_cur = (struct change_byte*) ck_alloc(sizeof(struct change_byte));
                dict1d_cur->outdata = lognow->outdata;
                dict1d_cur->type = lognow->type;
                dict1d_cur->countnum = 1;
                dict1d_cur->next = NULL;
                dict2d_cur->subdata = dict1d_cur;
                dict2d_prev->next = dict2d_cur;
            }
            else{
                dict1d_cur = dict2d_cur->subdata;
                dict1d = dict1d_cur;
                while (dict1d_cur)
                {
                    if(dict1d_cur->outdata == lognow->outdata && dict1d_cur->type == lognow->type)
                        break;
                    dict1d = dict1d_cur;
                    dict1d_cur = dict1d_cur->next;
                }
    ...
    for(int i = 0; i < 4096; i++)
    {
      ...
      while (dict2d_cur !=NULL)
      {
        if(dict2d_cur->usenum > 0)
        {
          ...
          while ( dict1d_cur->countnum >= dictcount)
          {
            tmpusenum += 1;
          ...
          if (tmpusenum < dict2d_cur->usenum )
          {
            ...
            while (dict1d_cur != NULL)
            {
              if(dict1d_cur->countnum >= dictcount)
              {
                if(dict1d_final == NULL)
                {
                  dict1d->next = dict1d_cur->next;
                  dict1d_cur->next = dict1d;
                  dict2d_cur->subdata = dict1d_cur;
                  dict1d_final = dict1d_cur;
                  ...
                  dict1d->next = dict1d_cur->next;
                  dict1d_cur->next = dict1d_final->next;
          ...
          if(tmpusenum != dict2d_cur->usenum)
          {
            ...
            while (dict1d != NULL)
            {
              printf("%llu    ", dict1d->countnum);
            }
            printf("\n\n\n");
            FATAL("error in sort case");
          }
...
void selection_update_distill(void){
    ...
    u64 totalnum = one_num + two_num + four_num;
    bytelen_prob[0] = (double)(one_num) / (double)(totalnum);
    bytelen_prob[1] = (double)(two_num) / (double)(totalnum) + bytelen_prob[0];
    bytelen_prob[2] = 1.0; //(double)(four_num) / (double)/totalnum + bytelen_prob[1];
}
...
#define STAGE_PCSG 16
#define STAGE_DISTILL 17
    ...
    if (key_puppet == 0)
    {
        if (key_module == 0)
        {
            sprintf(tmp + banner_pad, "%s " cLCY VERSION cLGN
                ...
                cYEL "EMS (pilot_fuzzing)", use_banner);
        }
        else if (key_module == 1)
        {
            sprintf(tmp + banner_pad, "%s " cLCY VERSION cLGN
                " (%s)", crash_mode ? cPIN "peruvian were-rabbit" :
                cYEL "EMS (core_fuzzing)", use_banner);
        }
        else if (key_module == 2)
        {
            sprintf(tmp + banner_pad, "%s " cLCY VERSION cLGN
                " (%s)", crash_mode ? cPIN "peruvian were-rabbit" :
                cYEL "EMS (pso_updating)", use_banner);
        }
    }
    else {
        ...
        if (key_module == 0)
        {
            sprintf(tmp + banner_pad, "%s " cLCY VERSION cLGN
                " (%s)", crash_mode ? cPIN "peruvian were-rabbit" :
                cYEL "EMS + pacemaker (pilot_fuzzing)", use_banner);
        }
        else if (key_module == 1)
        {
            sprintf(tmp + banner_pad, "%s " cLCY VERSION cLGN
                " (%s)", crash_mode ? cPIN "peruvian were-rabbit" :
                cYEL "EMS + pacemaker (core_fuzzing)", use_banner);
        }
        else if (key_module == 2)
        {
            sprintf(tmp + banner_pad, "%s " cLCY VERSION cLGN
                " (%s)", crash_mode ? cPIN "peruvian were-rabbit" :
                cYEL "EMS + pacemaker (pso_updating)", use_banner);
        }
    }
 }
 else{
...
EXP_ST u8 common_fuzz_stuff(char** argv, u8* out_buf, u32 len, struct loghistory* tmploghead, struct loghistory* tmplognow, u64* tmp_favorite_list, u64 tmp_favorite_list_num) {
...
if( (cur_time_lyu - start_time2) > 3600000 )
{
  ...
  if(unlikely(return_keeping > 0))
  {
      ...
      {
          int insert_list = 0;
          u64 hashlocation = tmp_favorite_list[jjj] % favorite_list_len;
          for(int ttt = 0; ttt < favorite_list_num[hashlocation]; ttt++)
          {
              if(favorite_list[hashlocation][ttt] == tmp_favorite_list[jjj])
              {
                  insert_list = 1;
                  break;
              }
          ...
          if(insert_list == 0)
          {
              favorite_list[hashlocation][favorite_list_num[hashlocation]] = tmp_favorite_list[jjj];
              if(favorite_list_num[hashlocation] == 0)
              {
                  have_value[value_num++] = hashlocation;
              }
              favorite_list_num[hashlocation]++;
          }
      }
  }
...
#define FLIP_BIT(_ar, _b) do { \
    ...
    for (stage_cur = 0; stage_cur < stage_max; stage_cur++) {
        ...
        if (common_fuzz_stuff(argv, out_buf, len, tmploghead, tmplognow, tmp_favorite_list, tmp_favorite_list_num)) goto abandon_entry;
...
#define EFF_SPAN_ALEN(_p, _l) (EFF_APOS((_p) + (_l) - 1) - EFF_APOS(_p) + 1)
    ...
    for (i = 0; i < len - 3; i++) {
        ...
        *(u32*)(out_buf + i) ^= 0xFFFFFFFF;
        ...
        tmplognow->outdata = *(u32*)(out_buf + stage_cur_byte); // (out_buf[stage_cur_byte]) << 24 + out_buf[stage_cur_byte + 1] << 16 + out_buf[stage_cur_byte + 2] << 8 + out_buf[stage_cur_byte + 3];
        ...
        for (j = 0; j < extras_cnt; j++) {
            ...
            switch (last_len) {
                ...
                case 2:{
                        ...
                        tmploghead->indata = *(u16*)(out_buf + i); 
                        tmploghead->bytelen = 2;
                        tmploghead->type = 0; //overwrite
                        tmploghead->next = NULL;
                ...
                case 4:{
                        ...
                        tmploghead->indata = *(u32*)(out_buf + i); 
                        tmploghead->bytelen = 4;
                        tmploghead->type = 0; //overwrite
                        tmploghead->next = NULL;
        ...
        for (j = 0; j < extras_cnt; j++) {
            ...
            switch (extras[j].len) {
                case 1:{
                    ...
                    tmplognow->outdata = ex_tmp[i]; 

                    break;}
                case 2:{
                        tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmploghead->indata = *(u16*)(ex_tmp + i); 
                        tmploghead->bytelen = 2;
                        tmploghead->type = 2; //insert
                        tmploghead->next = NULL;
                        tmplognow = tmploghead;
                    ...
                    memcpy(ex_tmp + i, extras[j].data, extras[j].len);
                    tmplognow->outdata = *(u16*)(ex_tmp + i);
                    break;}
                case 4:{
                        tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmploghead->indata = *(u32*)(ex_tmp + i); 
                        tmploghead->bytelen = 4;
                        tmploghead->type = 2; //insert
                        tmploghead->next = NULL;
                        tmplognow = tmploghead;
                    ...
                    memcpy(ex_tmp + i, extras[j].data, extras[j].len);
                    tmplognow->outdata = *(u32*)(ex_tmp + i); 
                    break;}
                default: {
                    memcpy(ex_tmp + i, extras[j].data, extras[j].len);
                    break;}
        ...
        for (i = 0; i < use_stacking; i++) {
            ...
            case 0:{
                ...
                /* Flip a single bit somewhere. Spooky! */
                    ...
                    u32 biti = UR(temp_len << 3);
                    if(unlikely(tmploghead == NULL))
                    {
                        tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmploghead->indata = out_buf[biti/8]; 
                        tmploghead->bytelen = 1;
                        tmploghead->type = 0; //overwrite
                        tmploghead->next = NULL;
                        tmplognow = tmploghead;
                    ...
                    {
                        struct loghistory *tmptmplog = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmptmplog->indata = out_buf[biti/8]; 
                        tmptmplog->bytelen = 1;
                        tmptmplog->type = 0; //overwrite
                        tmptmplog->next = NULL;
                        tmplognow->next = tmptmplog;
                        tmplognow = tmptmplog;
                    } 
                    FLIP_BIT(out_buf, biti);
                    tmplognow->outdata = out_buf[biti/8]; 
                    tmp_favorite_list[tmp_favorite_list_num++] = biti/8;
                break;
            }
            ...
            case 1:{
                ...
                /* Set byte to interesting value. */
                    ...
                    out_buf[biti] = interesting_8[UR(sizeof(interesting_8))];
                    tmplognow->outdata = out_buf[biti];
                    tmp_favorite_list[tmp_favorite_list_num++] = biti;
                break;
            }
            ...
            case 2:{
                ...
                if (temp_len < 2) break;
                    ...
                    u32 biti = UR(temp_len - 1);
                    if(unlikely(tmploghead == NULL))
                    {
                        tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmploghead->indata = *(u16*)(out_buf + biti);
                        tmploghead->bytelen = 2;
                        tmploghead->type = 0; //overwrite
                        tmploghead->next = NULL;
                        tmplognow = tmploghead;
                    ...
                    {
                        struct loghistory *tmptmplog = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmptmplog->indata = *(u16*)(out_buf + biti);
                        tmptmplog->bytelen = 2;
                        tmptmplog->type = 0; //overwrite
                        tmptmplog->next = NULL;
                        tmplognow->next = tmptmplog;
                    ...
                    if (UR(2)) {
                        ...
                        *(u16*)(out_buf + biti) = SWAP16(
                            interesting_16[UR(sizeof(interesting_16) >> 1)]);
                    }
                    tmplognow->outdata = *(u16*)(out_buf + biti);
            ...
            case 3:{
                ...
                if (temp_len < 4) break;
                    ...
                    {
                        tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmploghead->indata = *(u32*)(out_buf + biti);
                        tmploghead->bytelen = 4;
                        tmploghead->type = 0; //overwrite
                        tmploghead->next = NULL;
                        tmplognow = tmploghead;
                    ...
                    {
                        struct loghistory *tmptmplog = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmptmplog->indata = *(u32*)(out_buf + biti);
                        tmptmplog->bytelen = 4;
                        tmptmplog->type = 0; //overwrite
                        tmptmplog->next = NULL;
                        tmplognow->next = tmptmplog;
                ...
                if (UR(2)) {
                    ...
                    *(u32*)(out_buf + biti) = SWAP32(
                        interesting_32[UR(sizeof(interesting_32) >> 2)]);

                }
                tmplognow->outdata = *(u32*)(out_buf + biti);
                tmp_favorite_list[tmp_favorite_list_num++] = biti;
                break;
            }
            ...
            case 4:{
                ...
                /* Randomly subtract from byte. */
                    ...
                    {
                        tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmploghead->indata = out_buf[biti];
                        tmploghead->bytelen = 1;
                        tmploghead->type = 0; //overwrite
                        tmploghead->next = NULL;
                        tmplognow = tmploghead;
            ...
            case 6:{
                ...
                if (UR(2)) {
                    ...
                    *(u16*)(out_buf + biti) -= 1 + UR(ARITH_MAX);
                    ...
                    *(u16*)(out_buf + biti) =
                        SWAP16(SWAP16(*(u16*)(out_buf + biti)) - num);
            ...
            case 8:{
                ...
                if (UR(2)) {
                    ...
                    *(u32*)(out_buf + biti) -= 1 + UR(ARITH_MAX);
                    ...
                    *(u32*)(out_buf + biti) =
                        SWAP32(SWAP32(*(u32*)(out_buf + biti)) - num);
            ...
            switch (del_len) {
                case 1:{
                    ...
                    {
                        tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmploghead->indata = out_buf[del_from]; 
                        tmploghead->bytelen = 1;
                    ...
                    {
                        struct loghistory *tmptmplog = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmptmplog->indata = out_buf[del_from]; 
                        tmptmplog->bytelen = 1;
                        tmptmplog->type = 1; //delete
                        tmptmplog->next = NULL;
                        tmplognow->next = tmptmplog;
                        tmplognow = tmptmplog;
                    } 
                    ...
                    temp_len -= del_len;
                    tmplognow->outdata = out_buf[del_from]; 
                ...
                case 2:{
                    ...
                    {
                        tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmploghead->indata = *(u16*)(out_buf + del_from); 
                        tmploghead->bytelen = 2;
                        tmploghead->type = 1; //delete
                        tmploghead->next = NULL;
                        tmplognow = tmploghead;
                    ...
                    {
                        struct loghistory *tmptmplog = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmptmplog->indata = *(u16*)(out_buf + del_from);
                        tmptmplog->bytelen = 2;
                        tmptmplog->type = 1; //delete
                        tmptmplog->next = NULL;
                        tmplognow->next = tmptmplog;
                    ...
                    temp_len -= del_len;
                    tmplognow->outdata = *(u16*)(out_buf + del_from);
                    tmp_favorite_list[tmp_favorite_list_num++] = del_from;
                    break;}
                case 4:{
                    if(unlikely(tmploghead == NULL))
                    {
                        tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmploghead->indata = *(u32*)(out_buf + del_from); 
                        tmploghead->bytelen = 4;
                        tmploghead->type = 1; //delete
                        tmploghead->next = NULL;
                        tmplognow = tmploghead;
                    ...
                    {
                        struct loghistory *tmptmplog = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmptmplog->indata = *(u32*)(out_buf + del_from); 
                        tmptmplog->bytelen = 4;
                        tmptmplog->type = 1; //delete
                        tmptmplog->next = NULL;
                        tmplognow->next = tmptmplog;
                    ...
                    temp_len -= del_len;
                    tmplognow->outdata = *(u32*)(out_buf + del_from); 
                    tmp_favorite_list[tmp_favorite_list_num++] = del_from;
                    break;}
                default: {
            ...
            switch (clone_len) {
                case 1:{
                    ...
                    {
                        tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmploghead->indata = out_buf[clone_to]; 
                        tmploghead->bytelen = 1;
                        tmploghead->type = 2; //insert
                        tmploghead->next = NULL;
                        tmplognow = tmploghead;
                    ...
                    {
                        struct loghistory *tmptmplog = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmptmplog->indata = out_buf[clone_to]; 
                        tmptmplog->bytelen = 1;
                        tmptmplog->type = 2; //insert
                        tmptmplog->next = NULL;
                        tmplognow->next = tmptmplog;
                        tmplognow = tmptmplog;
                    } 
                    ...
                    memcpy(new_buf + clone_to + clone_len, out_buf + clone_to,
                        temp_len - clone_to);
                    tmplognow->outdata = new_buf[clone_to];
                ...
                case 2:{
                    ...
                    {
                        tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmploghead->indata = *(u16*)(out_buf + clone_to); 
                        tmploghead->bytelen = 2;
                        tmploghead->type = 2; //insert
                        tmploghead->next = NULL;
                        tmplognow = tmploghead;
                    ...
                    {
                        struct loghistory *tmptmplog = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmptmplog->indata = *(u16*)(out_buf + clone_to);
                        tmptmplog->bytelen = 2;
                        tmptmplog->type = 2; //insert
                        tmptmplog->next = NULL;
                        tmplognow->next = tmptmplog;
                    ...
                    tmplognow->outdata = *(u16*)(new_buf + clone_to); 
                    tmp_favorite_list[tmp_favorite_list_num++] = clone_to;
                ...
                case 4:{
                    ...
                    {
                        tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmploghead->indata = *(u32*)(out_buf + clone_to); 
                        tmploghead->bytelen = 4;
                        tmploghead->type = 2; //insert
                        tmploghead->next = NULL;
                        tmplognow = tmploghead;
                    ...
                    {
                        struct loghistory *tmptmplog = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmptmplog->indata = *(u32*)(out_buf + clone_to); 
                        tmptmplog->bytelen = 4;
                        tmptmplog->type = 2; //insert
                        tmptmplog->next = NULL;
                        tmplognow->next = tmptmplog;
                    ...
                    tmplognow->outdata = *(u32*)(new_buf + clone_to); 
                    tmp_favorite_list[tmp_favorite_list_num++] = clone_to;
                    break;}
                default: {
                    /* Head */
            ...
            switch (copy_len) {
                case 1:{
                    ...
                    {
                        tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmploghead->indata = out_buf[copy_to]; 
                        tmploghead->bytelen = 1;
                        tmploghead->type = 0; //overwrite
                        tmploghead->next = NULL;
                        tmplognow = tmploghead;
                    ...
                    {
                        struct loghistory *tmptmplog = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmptmplog->indata =  out_buf[copy_to]; 
                        tmptmplog->bytelen = 1;
                        tmptmplog->type = 0; //overwrite
                        tmptmplog->next = NULL;
                        tmplognow->next = tmptmplog;
                    ...
                    tmplognow->outdata = out_buf[copy_to];
                ...
                case 2:{
                    ...
                    {
                        tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmploghead->indata = *(u16*)(out_buf + copy_to); 
                        tmploghead->bytelen = 2;
                        tmploghead->type = 0; //overwrite
                        tmploghead->next = NULL;
                        tmplognow = tmploghead;
                    ...
                    {
                        struct loghistory *tmptmplog = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmptmplog->indata = *(u16*)(out_buf + copy_to); 
                        tmptmplog->bytelen = 2;
                        tmptmplog->type = 0; //overwrite
                        tmptmplog->next = NULL;
                        tmplognow->next = tmptmplog;
                    ...
                    memmove(out_buf + copy_to, out_buf + copy_from, copy_len);
                    tmplognow->outdata = *(u16*)(out_buf + copy_to); 
                    tmp_favorite_list[tmp_favorite_list_num++] = copy_to;
                ...
                case 4:{
                    ...
                    {
                        tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmploghead->indata = *(u32*)(out_buf + copy_to); 
                        tmploghead->bytelen = 4;
                        tmploghead->type = 0; //overwrite
                        tmploghead->next = NULL;
                        tmplognow = tmploghead;
                    ...
                    {
                        struct loghistory *tmptmplog = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmptmplog->indata = *(u32*)(out_buf + copy_to); 
                        tmptmplog->bytelen = 4;
                        tmptmplog->type = 0; //overwrite
                        tmptmplog->next = NULL;
                        tmplognow->next = tmptmplog;
                    ...
                    memmove(out_buf + copy_to, out_buf + copy_from, copy_len);
                    tmplognow->outdata = *(u32*)(out_buf + copy_to); 
                    tmp_favorite_list[tmp_favorite_list_num++] = copy_to;
            ...
            switch (extra_len) {
                case 1:{
                    ...
                    {
                        tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmploghead->indata = out_buf[insert_at]; 
                        tmploghead->bytelen = 1;
                        tmploghead->type = 0; //overwrite
                        tmploghead->next = NULL;
                        tmplognow = tmploghead;
                    ...
                    {
                        struct loghistory *tmptmplog = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmptmplog->indata =  out_buf[insert_at]; 
                        tmptmplog->bytelen = 1;
                        tmptmplog->type = 0; //overwrite
                        tmptmplog->next = NULL;
                        tmplognow->next = tmptmplog;
                    ...
                    tmplognow->outdata = out_buf[insert_at];
                ...
                case 2:{
                    ...
                    {
                        tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmploghead->indata = *(u16*)(out_buf + insert_at); 
                        tmploghead->bytelen = 2;
                        tmploghead->type = 0; //overwrite
                        tmploghead->next = NULL;
                        tmplognow = tmploghead;
                    ...
                    {
                        struct loghistory *tmptmplog = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmptmplog->indata = *(u16*)(out_buf + insert_at); 
                        tmptmplog->bytelen = 2;
                        tmptmplog->type = 0; //overwrite
                        tmptmplog->next = NULL;
                        tmplognow->next = tmptmplog;
                    ...
                    memcpy(out_buf + insert_at, a_extras[use_extra].data, extra_len);
                    tmplognow->outdata = *(u16*)(out_buf + insert_at); 
                    tmp_favorite_list[tmp_favorite_list_num++] = insert_at;
                ...
                case 4:{
                    ...
                    {
                        tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmploghead->indata = *(u32*)(out_buf + insert_at); 
                        tmploghead->bytelen = 4;
                        tmploghead->type = 0; //overwrite
                        tmploghead->next = NULL;
                        tmplognow = tmploghead;
                    ...
                    {
                        struct loghistory *tmptmplog = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmptmplog->indata = *(u32*)(out_buf + insert_at); 
                        tmptmplog->bytelen = 4;
                        tmptmplog->type = 0; //overwrite
                        tmptmplog->next = NULL;
                        tmplognow->next = tmptmplog;
                    ...
                    memcpy(out_buf + insert_at, a_extras[use_extra].data, extra_len);
                    tmplognow->outdata = *(u32*)(out_buf + insert_at); 
                    tmp_favorite_list[tmp_favorite_list_num++] = insert_at;
            ...
            switch (extra_len) {
                case 1:{
                    ...
                    tmplognow->outdata = new_buf[insert_at];
                    tmp_favorite_list[tmp_favorite_list_num++] = insert_at;
                    break;}
                case 2:{
                    if(unlikely(tmploghead == NULL))
                    ...
                    /* Inserted part */
                    memcpy(new_buf + insert_at, a_extras[use_extra].data, extra_len);
                    tmplognow->outdata = *(u16*)(new_buf + insert_at); 
                    tmp_favorite_list[tmp_favorite_list_num++] = insert_at;
                ...
                case 4:{
                    ...
                    /* Inserted part */
                    memcpy(new_buf + insert_at, a_extras[use_extra].data, extra_len);
                    tmplognow->outdata = *(u32*)(new_buf + insert_at); 
                    tmp_favorite_list[tmp_favorite_list_num++] = insert_at;
...
{		
    ...
    u32 tmpindata;
    stage_max = 0;
    u64 search_count = len/100;
    if(search_count < 2)
        search_count = len - 4;
    for(tmpjj = 0; tmpjj < search_count; tmpjj++)
    {

        select_location = random() % (len - 4);
        switch (uselen)
        {
        case 1:{
        ...
        tmp_favorite_list[0] = select_location;
        u64 tmp_favorite_list_num = 1;
                    if (common_fuzz_stuff(argv, new_buf, templen_l, tmploghead, tmplognow, tmp_favorite_list, tmp_favorite_list_num)) goto abandon_entry;
                    stage_max++;
                    ck_free(new_buf);
                    break;}
                ...
                case 2:{   //insert
                    ...
                    new_buf = ck_alloc_nozero(templen_l);
                    memcpy(new_buf, out_buf, select_location);
                    //memcpy(new_buf + select_location, (u8)(dict1d_cur->outdata), 1);
                    new_buf[select_location] = (u8)(dict1d_cur->outdata);
        ...
        u64 tmp_favorite_list_num = 1;
                ...
                case 2:{
                    ...
                    new_buf = ck_alloc_nozero(templen_l);
                    memcpy(new_buf, out_buf, select_location);
                    //memcpy(new_buf + select_location, (u16)(dict1d_cur->outdata), 2);
                    *(u16*)(new_buf + select_location) = (u16)(dict1d_cur->outdata);
        ...
        u64 tmp_favorite_list_num = 1;
                ...
                case 2:{
                    ...
                    memcpy(new_buf, out_buf, select_location);
                    //memcpy(new_buf + select_location, (u16)(dict1d_cur->outdata), 2);
                    *(u32*)(new_buf + select_location) = (u32)(dict1d_cur->outdata);
    ...
    new_hit_cnt = queued_paths + unique_crashes;
    stage_finds[STAGE_PCSG] += new_hit_cnt - orig_hit_cnt;
    stage_cycles[STAGE_PCSG] += stage_max;
    orig_hit_cnt = queued_paths + unique_crashes;
}
                ...
                for (stage_cur = 0; stage_cur < stage_max; stage_cur++) {
                    ...
                    for (i = 0; i < use_stacking; i++) {
                        ...
                        case 0:{
                            ...
                            {
                                tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                                tmploghead->indata = out_buf[(u32)(biti/8)]; 
                                tmploghead->bytelen = 1;
                                tmploghead->type = 0; //overwrite
                                tmploghead->next = NULL;
                                tmplognow = tmploghead;
                            ...
                            {
                                struct loghistory *tmptmplog = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                                tmptmplog->indata = out_buf[(u32)(biti/8)]; 
                                tmptmplog->bytelen = 1;
                                tmptmplog->type = 0; //overwrite
                                tmptmplog->next = NULL;
                                tmplognow->next = tmptmplog;
                            ...
                            FLIP_BIT(out_buf, biti);
                            tmplognow->outdata = out_buf[(u32)(biti/8)]; 
                            tmp_favorite_list[tmp_favorite_list_num++] = biti/8;
                        ...
                        case 1:{
                            ...
                            {
                                tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                                tmploghead->indata = out_buf[(u32)(temp_len_puppet/8)]; 
                                tmploghead->bytelen = 1;
                                tmploghead->type = 0; //overwrite
                                tmploghead->next = NULL;
                                tmplognow = tmploghead;
                           ...
                           {
                                struct loghistory *tmptmplog = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                                tmptmplog->indata = out_buf[(u32)(temp_len_puppet/8)]; 
                                tmptmplog->bytelen = 1;
                                tmptmplog->type = 0; //overwrite
                                tmptmplog->next = NULL;
                                tmplognow->next = tmptmplog;
                            ...
                            tmplognow->outdata = out_buf[(u32)(temp_len_puppet/8)]; 
                            tmp_favorite_list[tmp_favorite_list_num++] = temp_len_puppet/8;
                        ...
                        case 7:{
                            ...
                            if (UR(2)) {
                                ...
                                {
                                    tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                                    tmploghead->indata = *(u16*)(out_buf + pos); 
                                    tmploghead->bytelen = 2;
                                    tmploghead->type = 0; //overwrite
                                    tmploghead->next = NULL;
                                    tmplognow = tmploghead;
                                ...
                                {
                                    struct loghistory *tmptmplog = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                                    tmptmplog->indata = *(u16*)(out_buf + pos); 
                                    tmptmplog->bytelen = 2;
                                    tmptmplog->type = 0; //overwrite
                                    tmptmplog->next = NULL;
                                    tmplognow->next = tmptmplog;
                                ...
                                *(u16*)(out_buf + pos) -= 1 + UR(ARITH_MAX);
                                tmplognow->outdata = *(u16*)(out_buf + pos);
                                tmp_favorite_list[tmp_favorite_list_num++] = pos;
                            }
                            else {
                                u32 pos = UR(temp_len - 1);
                                u16 num = 1 + UR(ARITH_MAX);
                        ...
                        case 8:{
                            ...
                            if (UR(2)) {
                                ...
                                {
                                    tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                                    tmploghead->indata = *(u32*)(out_buf + pos); 
                                    tmploghead->bytelen = 4;
                                    tmploghead->type = 0; //overwrite
                                    tmploghead->next = NULL;
                                    tmplognow = tmploghead;
                                ...
                                {
                                    struct loghistory *tmptmplog = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                                    tmptmplog->indata = *(u32*)(out_buf + pos); 
                                    tmptmplog->bytelen = 4;
                                    tmptmplog->type = 0; //overwrite
                                    tmptmplog->next = NULL;
                                    tmplognow->next = tmptmplog;
                                ...
                                *(u32*)(out_buf + pos) -= 1 + UR(ARITH_MAX);
                                tmplognow->outdata = *(u32*)(out_buf + pos);
                                tmp_favorite_list[tmp_favorite_list_num++] = pos;
                            }
                            else {
                                u32 pos = UR(temp_len - 3);
...
case 16:{  //herehere
        ...
        int select_bool = 0;
        int uselen = select_bytelen();
        double sele1 = ((double)(random() % 1000000) * 0.000001);
        s32 select_location = 0;
        int keyselect = 0;
        if(value_num > 0 && sele1 < use_favorite_list)
        {
            int selecthash = have_value[UR(value_num)];
            select_location = favorite_list[selecthash][UR(favorite_list_num[selecthash])];
            keyselect = 1;
        }
        if(keyselect == 0 || select_location > temp_len - 4)
            select_location = random() % (temp_len - 4);
        double sele = ((double)(random() % 1000000) * 0.000001);
        switch (uselen)
        {
        case 1:{
            ...
            if(dict1d_cur)
            {
                ...
                case 0:{   //overwrite
                    ...
                    {
                        struct loghistory *tmptmplog = ck_alloc(sizeof(struct loghistory));
                        tmptmplog->indata = dict2d_cur->indata;
                        tmptmplog->bytelen = 1;
                        tmptmplog->type = 0;
                        tmptmplog->next = NULL;
                        tmplognow->next = tmptmplog;
                    ...
                    tmplognow->outdata = (dict1d_cur->outdata);
                    tmp_favorite_list[tmp_favorite_list_num++] = select_location;

                    break;}

                case 1:{   //delete 
                    s32 templen_l = temp_len - 1;
    ...
    if(select_bool)
        stage_cycles_puppet_v2[swarm_now][STAGE_PCSG] += 1;
    break;
}
...
case 17:{  //distill   part
        ...
        int select_bool = 0;
        int uselen = select_bytelen();
        s32 select_location = random() % (temp_len - 4);
        double sele = ((double)(random() % 1000000) * 0.000001);
        switch (uselen)
        {
        case 1:{
            ...
            if(dict1d_cur)
            {
                ...
                case 1:{   //delete 
                    ...
                    memcpy(new_buf, out_buf, select_location);
                    memcpy(new_buf + select_location, out_buf + select_location + 1, temp_len - select_location);
    ...
    if(select_bool)
        stage_cycles_puppet_v2[swarm_now][STAGE_DISTILL] += 1;
    break;
}
                                                ...
                                                /* Values 18 and 19 can be selected only if there are any extras
                                                   present in the dictionaries. */
        ...
        //for (; swarm_now < swarm_num; swarm_now++)
        {
            ...
            havoc_stage_puppet:
                ...
                FLIP_BIT(out_buf, biti);
                    ...
                    {
                        tmploghead = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmploghead->indata = out_buf[temp_len_puppet/8]; 
                        tmploghead->bytelen = 1;
                        tmploghead->type = 0; //overwrite
                        tmploghead->next = NULL;
                        tmplognow = tmploghead;
                    ...
                    {
                        struct loghistory *tmptmplog = (struct loghistory*) ck_alloc(sizeof(struct loghistory));
                        tmptmplog->indata = out_buf[temp_len_puppet/8]; 
                        tmptmplog->bytelen = 1;
                        tmptmplog->type = 0; //overwrite
                        tmptmplog->next = NULL;
                        tmplognow->next = tmptmplog;
                        tmplognow = tmptmplog;
                            ...
                            FLIP_BIT(out_buf, temp_len_puppet);
                            FLIP_BIT(out_buf, temp_len_puppet + 1);
                    tmplognow->outdata = out_buf[temp_len_puppet/8]; 
                    tmp_favorite_list[tmp_favorite_list_num++] = temp_len_puppet/8;
...
case 16:{  //herehere
    ...
    if(select_bool)
        core_operator_cycles_puppet_v2[STAGE_PCSG] += 1;
    break;
}
...
case 17:{
    ...
    if(select_bool)
        core_operator_cycles_puppet_v2[STAGE_DISTILL] += 1;
    break;
}
      ...
      case 'G':{
        ...
        while(!feof(fp))
        {
            ...
            case 0:{
                ...
                int tmpbytelen;
                u64 tmptotalcount;
                u64 tmpsubdata_count;
                    feoffp = fscanf(fp,"%u",&tmpindata);    //indata
                    if (feoffp == -1)
                        break;
                    ...
                    tmpfeoffp = fscanf(fp,"%llu",&tmpsubdata_count);    //subdata_count
                        ...
                        if(dict2d_hash[tmpindata % 4096])
                        {
                            ...
                            {
                                dict2d_cur = (struct start_byte*) ck_alloc(sizeof(struct start_byte));
                                dict2d_cur->indata = tmpindata;
                                dict2d_cur->bytelen = tmpbytelen;
                                dict2d_cur->totalcount = tmptotalcount;
                                ...
                                {
                                    printf("linenum: %llu,", linenum);
                                    printf("1: %s\n", dicttxt);
                                    FATAL("error startbyte1");
                                }
                                state_dict = 1;
                            }
                            else
                                FATAL("error dict2d_cur search");
                        }
                        else{
                            dict2d_cur = (struct start_byte*) ck_alloc(sizeof(struct start_byte));
                            dict2d_cur->indata = tmpindata;
            ...
            case 1:{
                ...
                u64 tmpcountnum;
                double tmpprob;
                tmpfeoffp = fscanf(fp,"%u",&tmpoutdata);
                tmpfeoffp = fscanf(fp,"%d",&tmptype);
                tmpfeoffp = fscanf(fp,"%llu",&tmpcountnum);
                tmpfeoffp = fscanf(fp,"%lf",&tmpprob);
                dict1d_cur = dict2d_cur->subdata;
                dict1d = dict1d_cur;
                if(dict2d_cur->subdata == NULL)
                {
                    dict1d_cur = (struct change_byte*) ck_alloc(sizeof(struct change_byte));
                    dict1d_cur->outdata = tmpoutdata;
                    ...
                    while (dict1d_cur)
                    {
                        if(dict1d_cur->outdata == tmpoutdata && dict1d_cur->type == tmptype)
                            break;
                        dict1d = dict1d_cur;
                        dict1d_cur = dict1d_cur->next;
                    }
                    if(dict1d_cur)
                        FATAL("error when match dict1d_cur");
                    else{
                        dict1d_cur = (struct change_byte*) ck_alloc(sizeof(struct change_byte));
                        dict1d_cur->outdata = tmpoutdata;
                        dict1d_cur->type = tmptype;
                ...
                tmpfeoffp = fscanf(fp,"%s",dicttxt);
                if (strcmp(dicttxt, "samebyte") == 0 )
                {
                    state_dict = 1;
                }
                else if(strcmp(dicttxt, "changebyte") == 0 )
                {
                    state_dict = 0;
                }
                else
                {
                    FATAL("error in samebyte/changebyte");
                }
                linenum += 5;
...
break;
  ...
  bytelen_prob[0] = 0.33333333333333333333333; 
  bytelen_prob[1] = 0.66666666666666666666666;
  bytelen_prob[2] = 1.00000000000000000000000;
  last_hit_cnt = 0;
  for(int jjj = 0; jjj < favorite_list_len; jjj++)
    favorite_list_num[jjj] = 0;
...
if(most_time_key ==1)
{
    if( most_time_puppet * 1000 <  cur_ms_lv  - start_time) // most_time_puppet: s
    break;
}
